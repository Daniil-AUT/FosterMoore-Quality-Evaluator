...
class FlaskAppTests(unittest.TestCase):
    ...
    def test_predict_well_formed_valid_story(self):
        ...
        print("\nResponse for valid well-formed story:", response.get_json())  # Print actual response
    ...
    def test_predict_well_formed_missing_story(self):
        payload = {}
        response = self.client.post('/predict/well-formed', data=json.dumps(payload), content_type='application/json')
        print("\nResponse for missing well-formed story:", response.get_json())  # Print actual response
    ...
    def test_predict_ambiguity_valid_story(self):
        ...
        print("\nResponse for valid ambiguity story:", response.get_json())  # Print actual response
        self.assertEqual(response.status_code, 200)
        data = response.get_json()
    ...
    def test_predict_ambiguity_missing_story(self):
        payload = {}
        response = self.client.post('/predict/ambiguity', data=json.dumps(payload), content_type='application/json')
        print("\nResponse for missing ambiguity story:", response.get_json())  # Print actual response
        self.assertEqual(response.status_code, 400)
        data = response.get_json()
        self.assertIn('error', data)
    ...
    def test_get_user_stories_missing_parameters(self):
        ...
        print("\nResponse for missing parameters in Jira user stories:", response.get_json())  # Print actual response
        self.assertEqual(response.status_code, 400)
        data = response.get_json()
        self.assertIn('error', data)
    ...
    def test_verify_credentials_missing(self):
        ...
        print("\nResponse for missing credentials in verification:", response.get_json())  # Print actual response
        self.assertEqual(response.status_code, 400)
        data = response.get_json()
        self.assertIn('error', data)
